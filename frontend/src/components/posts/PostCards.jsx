    ...
    <>
      {posts &&
        posts.map((post) => (
          <div
            key={post.id}
            className="relative my-2 flex w-full max-w-3xl cursor-pointer flex-col gap-3 rounded-3xl bg-white/90 px-4 py-3 shadow-lg shadow-red-800/20 transition-all duration-300 hover:shadow-2xl md:my-4 md:p-6 dark:bg-[#040303]/90"
          >
